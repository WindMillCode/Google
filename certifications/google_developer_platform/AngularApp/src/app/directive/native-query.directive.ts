...
@Directive({
    selector: '[appNativeQuery]'
})
export class NativeQueryDirective {

    @Input() nativeQuery: any;
    extras: any;
    zChildren: any;
    agGrid:any = {
        zSymbol:""
        ...
        if (this.extras?.confirm === 'true') {
            ...
            .subscribe({
                ...
                next: (result: any) => {
                    ...
                    switch (true) {
                        case env.nativeQuery.interactive:
                            ...
                            break;
                        case env.nativeQuery.parameterized:
                            result = JSON.parse(result)
                            this.zChildren[this.agGrid.zSymbol].extras.appAgGrid.rowData = result.data
                            this.zChildren[this.agGrid.zSymbol].extras.appAgGrid.columnDefs  = result.schema
                            update.innerText = "The query data was returned"
