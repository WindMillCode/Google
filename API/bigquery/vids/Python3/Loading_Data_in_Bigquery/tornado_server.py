...
import loading
from loading import my_bigquery_client
import time
import datetime
import os
...
class ModuleFinder(importlib.machinery.PathFinder):
    ...
    def __init__(self):
        self.path_map = {"loading":loading.__spec__.loader}
...
def start_app(*args, **kwargs):
    ...
    while loading_error:
        try:
            reload(loading)
            my_bigquery_client_code = loading.my_bigquery_client().execute.__code__
            my_client.env = loading.my_bigquery_client().env
            loading_error = False
